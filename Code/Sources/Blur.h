...
int Blur::BlurImage(const Mat& sourceImage, Mat& destinationImage, int kWidth, int kHeight, int method)
{
	...
	*/
	...
	{
		/*
		Mặc định sigma = 1, nếu muốn thay đổi chỉ cần sửa biến sigma
	...
	convolution.SetKernel(kernel, division, kWidth, kHeight);
